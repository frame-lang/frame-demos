...
class HistoryBasic {
    ...
    constructor () {
        ...
        this.#compartment = new HistoryBasicCompartment(this.#state);
    ...
    #sStart_(e) {
        switch (e._message) {
            case ">>":
                {
                let compartment =  new HistoryBasicCompartment(this.#sS0_);
    ...
    #sS0_(e) {
        switch (e._message) {
            ...
            case "switchState":
                {
                // Switch\nState
                let compartment =  new HistoryBasicCompartment(this.#sS1_);
            ...
            case "gotoDeadEnd":
                ...
                // Goto\nDead End
                let compartment =  new HistoryBasicCompartment(this.#sDeadEnd_);
...
module.exports = HistoryBasicController
