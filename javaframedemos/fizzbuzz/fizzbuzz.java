class FizzBuzz {
    ...
    private void _sFizz_(FrameEvent e) {
        if(e._message == ">") {
            ...
            if (mod3_eq0_do(((int) e._parameters.get("i")))) {
                ...
                compartment.enterArgs.put("i", (int) e._parameters.get("i"));
    ...
    private void _sBuzz_(FrameEvent e) {
        if(e._message == ">") {
            if (mod5_eq0_do(((int) e._parameters.get("i")))) {
                ...
                FizzBuzzCompartment compartment =  new FizzBuzzCompartment(FizzBuzzState.FIZZ.getValue());
                compartment.enterArgs.put("i", plus_1_do((int) e._parameters.get("i")));
    ...
    private void _sDigit_(FrameEvent e) {
        if(e._message == ">") {
            print_do(String.valueOf(((int) e._parameters.get("i"))).toString());
            print_do(" ");
            // loop
            FizzBuzzCompartment compartment =  new FizzBuzzCompartment(FizzBuzzState.FIZZ.getValue());
            compartment.enterArgs.put("i", plus_1_do((int) e._parameters.get("i")));
    ...
    protected boolean gt_100_do(int i) { throw new UnsupportedOperationException(); }
    protected boolean mod3_eq0_do(int i) { throw new UnsupportedOperationException(); }
    protected boolean mod5_eq0_do(int i) { throw new UnsupportedOperationException(); }
    protected int plus_1_do(int i) { throw new UnsupportedOperationException(); }
