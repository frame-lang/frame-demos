...
class CompartmentParams {
    ...
    private void _sS0_(FrameEvent e) {
        if(e._message == ">") {
            print_do(((int) this._compartment_.stateArgs.get("state_param")) + " " + ((int) this._compartment_.stateVars.get("state_var")) + " " + String.valueOf(((int) e._parameters.get("enter_param"))));
